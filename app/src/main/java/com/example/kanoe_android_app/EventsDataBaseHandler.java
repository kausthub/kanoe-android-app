...
public class EventsDataBaseHandler extends SQLiteOpenHelper {
 ...
 // Creating Tables
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                ...
                + KEY_DATE + " TEXT,"+ KEY_PLACE + " TEXT," +KEY_DESCRIPTION+ " TEXT," +KEY_REMARKS+ " TEXT)";
 ...
 // Adding new contact
    public void addContact(Events event) 
    {
        ...
        values.put(KEY_REMARKS, event.getRemarks());
        // Inserting Row
    	 ...
    	 List<Events> eventList = new ArrayList<Events>();
    	    ...
    	    if (cursor.moveToFirst()) {
    	        do {
    	            ...
    	            contact.setRemarks(cursor.getString(5));
