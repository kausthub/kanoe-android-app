...
private ProjectsDataBaseHandler edb;
	
	private static final String AUTHORITY = "com.example.kanoe.ProjectsProvider1";
	...
	public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY
	 ...
	 public boolean onCreate() {
	  edb = new ProjectsDataBaseHandler(getContext());
	  return true;
	 }
	 @Override
